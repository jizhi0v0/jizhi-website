...
- Multiple Code sessions can be split into side-by-side windows, so several tasks' progress sits on one screen instead of behind separate tabs — drag sessions out from the sidebar, or right-click → Open in → Split view. A Claude app developer showed off this layout:

  <Tweet url="https://x.com/amorriscode/status/2070578451854291178" name="Anthony Morris ツ" handle="amorriscode" date="2:42 AM · Jun 27, 2026" verified avatar="/posts/turn-to-claude-desktop/amorriscode-avatar.png" video="/posts/turn-to-claude-desktop/split-view.mp4" poster="/posts/turn-to-claude-desktop/split-view-poster.jpg" imageAlt="Claude Desktop splitting multiple Code sessions into side-by-side windows">
    going into the weekend like<br />
    迎接周末的样子
  </Tweet>
