...
- It's still beta. It's enough as a lightweight, rule-driven entry into your internal network; for the full Tailscale experience, install the official client — it coexists with Surge's built-in node just fine, with no extra config.
