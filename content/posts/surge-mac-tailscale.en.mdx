...
- `underlying-proxy="proxy"` wraps the control and DERP traffic in an outbound proxy; `"proxy"` is the name of one of your own existing ordinary policies (the empty `proxy =` above is yours to fill in with a real node).
