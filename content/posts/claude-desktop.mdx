...
- Desktop 自带 Chat & Code 的 need input / need review 通知 & 指示灯，无缝衔接切换本地 & 云端 & SSH 会话，而无需使用第三方 app 进行会话管理和跳转。
  ...
  ![Desktop 会话列表中的待办指示灯](/posts/claude-desktop/sessions.png)
- Terminal 和 IDE 分离，你同样可以在 Desktop 进行 diff review，甚至编辑文件。TUI 能做的事 Desktop 中都能做到。现在 auto mode 已推出，IDE 更多是一个纯粹的编辑器。

  ![Desktop 内置的 Preview / Diff / Terminal / Files 面板](/posts/claude-desktop/panel.png)

  ![会话菜单 Open in：VS Code / Zed / Cloud / Finder](/posts/claude-desktop/open-in.png)
- Code 会话可以更轻松看见 usage / context，而无需打断当前对话。

  ![Context window 与 Plan usage 面板](/posts/claude-desktop/usage.png)
